...
import ClickableImageContainer from 'containers/ClickableImage.container';
...
export default () => (
   <div className="page project dualscape">
      ...
      <ClickableImageContainer src={ require('images/01_glazesouth.jpg') } />
      <ClickableImageContainer src={require('images/04_hapticnorth.jpg')} />
      ...
      <ClickableImageContainer src={require('images/dualscapeaxo.png')} />
      ...
      <ClickableImageContainer src={require('images/detail.jpg')} />

      <ClickableImageContainer src={require('images/DSC_6966.jpg')} />
      <ClickableImageContainer src={require('images/DSC_6989.jpg')} />

      <ClickableImageContainer src={require('images/DSC_7003.jpg')} />
      <ClickableImageContainer src={require('images/DSC_7053.jpg')} />
   </div>
);
